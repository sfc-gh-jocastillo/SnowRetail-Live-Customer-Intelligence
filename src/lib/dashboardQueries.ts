...
export const DOMAIN_DASHBOARDS: Record<string, DashboardConfig> = {
  ...
  omn: {
    ...
    fallbackRows: [
      { AISLE: 'Pasillo 7', TRAFFIC: 5235, CONVERSION: 0.176, REV_SQFT: 1152 },
      { AISLE: 'Pasillo 1', TRAFFIC: 4549, CONVERSION: 0.154, REV_SQFT: 978 },
      { AISLE: 'Pasillo 12', TRAFFIC: 3833, CONVERSION: 0.151, REV_SQFT: 923 },
      { AISLE: 'Pasillo 5', TRAFFIC: 4118, CONVERSION: 0.139, REV_SQFT: 824 },
      { AISLE: 'Pasillo 2', TRAFFIC: 4830, CONVERSION: 0.131, REV_SQFT: 752 },
      { AISLE: 'Pasillo 15', TRAFFIC: 4015, CONVERSION: 0.129, REV_SQFT: 492 },
      { AISLE: 'Pasillo 9', TRAFFIC: 843, CONVERSION: 0.030, REV_SQFT: 129 },
      { AISLE: 'Pasillo 19', TRAFFIC: 955, CONVERSION: 0.039, REV_SQFT: 149 },
      { AISLE: 'Pasillo 6', TRAFFIC: 1099, CONVERSION: 0.040, REV_SQFT: 184 },
      { AISLE: 'Pasillo 16', TRAFFIC: 1191, CONVERSION: 0.050, REV_SQFT: 500 },
    ],
  },
  com: {
    kpis: [
